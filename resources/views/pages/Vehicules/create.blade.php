                                    ...
                                    <div class="col-sm-6 col-xl-4 mb-5">
                                        ...
                                        <div class="input-group">
                                            <select name="type_carburant" id="type_carburant"
                                                class="form-select @error('type_carburant') is-invalid @enderror" required>
                                                ...
                                                <option value="Électrique"
                                                    ...
                                                    Électrique</option>
                                                <option value="GPL"
                                                    {{ old('type_carburant') === 'GPL' ? 'selected' : '' }}>GPL</option>
                                            </select>
                                            <span class="input-group-text">
                                    ...
                                    <div class="col-sm-6 col-xl-4 mb-5">
                                        ...
                                        <div class="input-group">
                                            <select name="categorie_vehicule" id="categorie_vehicule"
                                                class="form-select @error('categorie_vehicule') is-invalid @enderror"
                                                required>
                                                <option value="">Sélectionner une catégorie</option>
                                                <option value="Berline"
                                                    {{ old('categorie_vehicule') === 'Berline' ? 'selected' : '' }}>Berline
                                                </option>
                                                <option value="SUV"
