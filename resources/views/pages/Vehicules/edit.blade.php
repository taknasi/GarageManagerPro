        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <form method="POST" action="{{ route('vehicules.update', $vehicule->id) }}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xl-4 mb-5">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('n_chassis') is-invalid @enderror"
                                            id="n_chassis" name="n_chassis" value="{{ $vehicule->n_chassis }}"
                                            required />
                                        <span class="input-group-text">
                                ...
                                <div class="col-sm-6 col-xl-4 mb-5">
                                    ...
                                    <div class="input-group">
                                        <input type="number"
                                            ...
                                            value="{{ $vehicule->annee_fabrication }}" required min="1900"
                                            max="{{ date('Y') + 2 }}" />
                                        <span class="input-group-text">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="flex-fill">
                                            <select name="type_carburant" id="type_carburant"
                                                ...
                                                <option value="Essence" {{ old('type_carburant', $vehicule->
                                                    type_carburant) === 'Essence' ? 'selected' : '' }}>
                                                    Essence
                                                </option>
                                                <option value="Diesel" {{ old('type_carburant', $vehicule->
                                                    type_carburant) === 'Diesel' ? 'selected' : '' }}>
                                                    Diesel
                                                </option>
                                                <option value="Hybride" {{ old('type_carburant', $vehicule->
                                                    type_carburant) === 'Hybride' ? 'selected' : '' }}>
                                                    Hybride
                                                </option>
                                                <option value="Électrique" {{ old('type_carburant', $vehicule->
                                                    type_carburant) === 'Électrique' ? 'selected' : '' }}>
                                                    Électrique</option>
                                                <option value="GPL" {{ old('type_carburant', $vehicule->type_carburant)
                                                    === 'GPL' ? 'selected' : '' }}>
                                                    GPL</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="input-group">
                                        <div class="flex-fill">
                                            <select name="categorie" id="categorie"
                                                ...
                                                <option value="Berline" {{ old('categorie', $vehicule->categorie) ===
                                                    'Berline' ? 'selected' : '' }}>
                                                    Berline
                                                </option>
                                                <option value="SUV" {{ old('categorie', $vehicule->categorie) === 'SUV'
                                                    ? 'selected' : '' }}>
                                                    SUV
                                                </option>
                                                <option value="Camionnette" {{ old('categorie', $vehicule->categorie)
                                                    === 'Camionnette' ? 'selected' : '' }}>
                                                    Camionnette</option>
                                                <option value="Moto" {{ old('categorie', $vehicule->categorie) ===
                                                    'Moto' ? 'selected' : '' }}>
                                                    Moto
                                                </option>
                                                <option value="Autre" {{ old('categorie', $vehicule->categorie) ===
                                                    'Autre' ? 'selected' : '' }}>
                                                    Autre
                                                </option>
                                            </select>
                                ...
                                <div class="col-sm-6 col-xl-4 mb-5">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('couleur') is-invalid @enderror"
                                            id="couleur" name="couleur" value="{{ $vehicule->couleur }}" required />
                                        <span class="input-group-text">
                                ...
                                <div class="col-sm-6 col-xl-4 mb-5">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                            ...
                                            value="{{ $vehicule->kilometrage_actuel }}" required />
                                        <span class="input-group-text">
                                ...
                                <div class="col-sm-6 col-xl-4 mb-5">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                            ...
                                            value="{{ $vehicule->puissance_fiscale }}" required />
                                        <span class="input-group-text">
                                ...
                                <div class="col-sm-6 col-xl-4 mb-5">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                            ...
                                            value="{{ $vehicule->compagnie_assurance }}" required />
                                        <span class="input-group-text">
                                ...
                                <div class="col-sm-6 col-xl-4 mb-5">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                            class="form-control @error('numero_de_police') is-invalid @enderror"
                                            id="numero_de_police" name="numero_de_police"
                                            value="{{ $vehicule->numero_de_police }}" required />
                                        <span class="input-group-text">
                                            <i class="bi bi-shield-lock fs-2"></i>
                                        </span>
                                    </div>
                                    @error('numero_de_police')
                                    <div class="fv-plugins-message-container invalid-feedback">
                                        {{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-4 text-center d-xl-block d-none d-flex align-self-center">
                                        <a href="{{ asset('images/' . $photo->photo) }}" target="_blank">
                                            <img src="{{ asset('images/' . $photo->photo) }}" alt="Vehicule Image"
                                                class="w-20 h-20 object-cover" width="300" height="300">
                                        </a>
                                    </div>
                                    <div class="col-2 text-center d-xl-block d-none d-flex align-self-center">
                                        <a href="#"
                    ...
                    <!-- Submit Buttons -->
                    <div class="d-flex">
                        <button type="submit" name="action" id="submitBtn" value="save" class="btn btn-primary me-2">
